        ...
        <nav className="w-full border-b border-[#1A1C21] bg-[#0D0F12] text-white">
            <div className="container mx-auto flex h-14 items-center justify-between px-4">
                ...
                <div className="flex items-center gap-1 text-[14px]">
                    <button className="rounded-full bg-[#263500] px-3 py-1.5 font-medium text-[#C2F800] cursor-pointer">
                        Workouts
                    </button>

                    <button className="px-3 py-1.5 text-[#8B8D93] hover:text-white cursor-pointer">
                        My Plan
                    </button>
                </div>
